...
import com.Suzj.extraenchantments.Item.ItemToggleable;
...
public class InventoryHelper {
    ...
    public static boolean hasItemStack(ItemStack itemStack , EntityPlayer player){
        for(int i = 0;i < player.inventory.mainInventory.size(); i++){
            ItemStack itemStack1 = player.inventory.mainInventory.get(i);
