...
public class SCNHandler {
    ...
    public void HandleEnchant(LivingHurtEvent fEvent)
    {
        ...
        if(reg.SCN.isOffensivePetDisallowed(fEvent.getSource().getImmediateSource(), fEvent.getSource().getTrueSource()))
            return;
        ...
        if(victim != null)
        {
            ...
            if(i==2){if(victim instanceof EntityZombie ||victim instanceof EntitySkeleton ||victim instanceof EntityWither ||victim instanceof EntityWitherSkeleton)
            {
